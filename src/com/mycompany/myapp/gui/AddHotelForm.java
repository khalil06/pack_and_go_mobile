...
public class AddHotelForm extends Form{
    ...
    public AddHotelForm(Form previous, Resources res) {      
        ...
        Form hii = new Form("Nombre d'étaoiles", new BoxLayout(BoxLayout.Y_AXIS));  
        Slider o = createStarRankSlider(theme);
        hii.add(FlowLayout.encloseCenter(o));        
                ...
                FileChooser.showOpenDialog(multiSelect.isSelected(), ".jpeg, .jpg, .jpg, .png/plain", (ActionEvent e2)->{
                    ...
                    if(file.lastIndexOf(".") > 0){
                        ...
                        /*   
                            ...
                            Files.copy(sf.toPath(),dest.toPath(),  StandardCopyOption.ATOMIC_MOVE);*/
                        /*    InputStream stream = FileSystemStorage.getInstance().openInputStream(file);
                            OutputStream out = Storage.getInstance().createOutputStream("http://localhost/hotelWeb/public/uploads");
        ...
        addAll(tfNomHotel,hii, tfNbrChambres,tfAdresse,tfPays,tfTel,tfEmail,btnImg,btnValider);    
