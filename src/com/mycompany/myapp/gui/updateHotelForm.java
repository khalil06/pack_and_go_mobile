...
public class updateHotelForm extends Form{
    ...
    public updateHotelForm(Form previous, Hotel t){
        ...
        TextField tfImage= new TextField(t.getImage(), "Image", 20, TextField.ANY);
        ...
        addAll(tfNomHotel,cbEtoiles, tfNbrChambres,tfAdresse,tfPays,tfTel,tfEmail,tfImage,btnValider);
    }
}
