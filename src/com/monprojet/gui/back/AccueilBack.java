package com.monprojet.gui.back;
...
import com.monprojet.gui.Login;
...
public class AccueilBack extends Form {
    ...
    private Button makeClientsButton() {
        ...
        button.addActionListener(action -> new com.monprojet.gui.back.client.ShowAll(this).show());
        return button;
    }
    private Button makeCompanysButton() {
        ...
        button.setUIID("buttonMenu");
        //button.setMaterialIcon(FontImage.MATERIAL_BOOKMARK);
        button.addActionListener(action -> new com.monprojet.gui.back.company.ShowAll(this).show());
        return button;
    }
    private Button makeReservationsButton() {
        ...
        button.setUIID("buttonMenu");
        //button.setMaterialIcon(FontImage.MATERIAL_BOOKMARK);
        button.addActionListener(action -> new com.monprojet.gui.back.reservation.ShowAll(this).show());
        return button;
    }
    private Button makeVolsButton() {
        ...
        button.setUIID("buttonMenu");
        //button.setMaterialIcon(FontImage.MATERIAL_BOOKMARK);
        button.addActionListener(action -> new com.monprojet.gui.back.vol.ShowAll(this).show());
        return button;
    }
