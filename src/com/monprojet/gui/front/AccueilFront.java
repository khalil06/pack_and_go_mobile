package com.monprojet.gui.front;
...
public class AccueilFront extends Form {
    ...
    private Button makeCompanysButton() {
        ...
        button.addActionListener(action -> new com.monprojet.gui.front.company.ShowAll(this).show());
        return button;
    }
    private Button makeReservationsButton() {
        ...
        button.setUIID("buttonMenu");
        //button.setMaterialIcon(FontImage.MATERIAL_BOOKMARK);
        button.addActionListener(action -> new com.monprojet.gui.front.reservation.ShowAll(this).show());
        return button;
    }
    private Button makeVolsButton() {
        ...
        button.setUIID("buttonMenu");
        //button.setMaterialIcon(FontImage.MATERIAL_BOOKMARK);
        button.addActionListener(action -> new com.monprojet.gui.front.vol.ShowAll(this).show());
        return button;
    }
