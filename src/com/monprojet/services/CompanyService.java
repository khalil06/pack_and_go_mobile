...
public class CompanyService {
    ...
    public ArrayList<Company> getAll() {
        ...
        cr = new ConnectionRequest();
        cr.setUrl(Statics.BASE_URL + "/company");
    ...
    public int manage(Company company, boolean isEdit, boolean imageEdited) {
        ...
        if (isEdit) {
            cr.setUrl(Statics.BASE_URL + "/company/edit");
            cr.addArgumentNoEncoding("id", String.valueOf(company.getId()));
        } else {
            cr.setUrl(Statics.BASE_URL + "/company/add");
        }
    ...
    public int delete(int companyId) {
        cr = new ConnectionRequest();
        cr.setUrl(Statics.BASE_URL + "/company/delete");
        cr.setHttpMethod("POST");
